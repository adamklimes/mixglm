...
precipitation, temperature, and predicted precipitation for the end of 21^s^t  century 
...
```{r aux, include = FALSE}
# To facilitate the build of this article, models are not fitted but just loaded.
...
names(modPT$data) <- "treeCoverProp"
```

```{r modelPT, eval = FALSE}
set.seed(21)
modPT <- mixglm(
